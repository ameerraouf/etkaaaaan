...
{!! Form::open(['route'=>'VideoCategory.store']) !!}
<div class="form-body">
...
{{-- {!! Form::select('parent',App\VideosCategory::where('parent',0)->pluck('title','id'),old('parent'),['class'=>'form-control','placeholder'=>trans('admin.main')]) !!} --}}
