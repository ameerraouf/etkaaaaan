...
<script src="{{url('assets')}}/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>

<script src="{{url('assets')}}/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
...
<script src="{{url('assets')}}/scripts/custom/index.js" type="text/javascript"></script>
<script src="{{url('assets')}}/scripts/custom/tasks.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/gritter/js/jquery.gritter.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/jquery-bootpag/jquery.bootpag.min.js" type="text/javascript"></script>
<script src="{{url('assets')}}/plugins/holder.js" type="text/javascript"></script>
...
<script src="{{url('assets')}}/scripts/custom/ui-general.js" type="text/javascript"></script>
<script src="{{url('assets')}}/scripts/custom/inbox.js" type="text/javascript"></script>
            ...
            <div class="modal-dialog">
               <div class="modal-content">
                  ...
                  <div class="modal-footer">
                     <button type="button" class="btn red modalbtndel">{{ trans('admin.delete') }}</button>
                     <button type="button" class="btn green" data-dismiss="modal">{{ trans('admin.cancel') }}</button>
                  </div>
               </div>
               <!-- /.modal-content -->
            </div>
