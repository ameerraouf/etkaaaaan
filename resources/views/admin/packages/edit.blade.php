...
{!! Form::open(['url'=>app('aurl').'/packages/'.$edit->id,'method'=>'put']) !!}
<div class="form-body">
...
<input name="price" type="number" placeholder="{{ trans('admin.price') }}" class="form-control" value="{{ $edit->price }}" placeholder="{{ trans('admin.price') }}"> USD دولار 
</div>
