...
{!! Form::open(['url'=>app('aurl').'/Market/'.$said->id,'method'=>'put','files' => true]) !!}
...
<div class="form-group">
<label>السعر</label>
<input name="price" type="text" required placeholder="السعر" class="form-control" value="{{ $said->price }}">
</div>

<div class="form-group">
<label>االوصف</label>
<textarea class="form-control" required name="description">{{ $said->description }}</textarea>
</div>
