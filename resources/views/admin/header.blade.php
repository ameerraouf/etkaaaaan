...
<head>
<meta charset="utf-8"/>
<title>@if(!empty($title)) {{ $title }} @else {{ trans('main.controlpanel') }} @endif</title>
...
<link href="{{url('assets')}}/plugins/gritter/css/jquery.gritter-rtl.css" rel="stylesheet" type="text/css"/>
...
<link href="{{url('assets')}}/css/pages/tasks-rtl.css" rel="stylesheet" type="text/css"/>
...
<link href="{{url('assets')}}/dist/css/bootstrap-datepicker.min.css" rel="stylesheet" type="text/css"/>
<link href="{{url('assets')}}/css/pages/inbox-rtl.css" rel="stylesheet" type="text/css"/>
<style type="text/css">
...
<link rel="stylesheet" type="text/css" href="{{url('assets')}}/plugins/select2/select2-rtl.css"/>
<link rel="stylesheet" type="text/css" href="{{url('assets')}}/plugins/select2/select2-metronic-rtl.css"/>

<script src="{{url('assets')}}/plugins/jquery-1.10.2.min.js" type="text/javascript"></script>
<script src="{{url('assets')}}/dist/js/bootstrap-datepicker.min.js" type="text/javascript"></script>

<script src="{{url('assets')}}/scripts/custom/form-samples.js" type="text/javascript"></script>
