...
@section('admin')
<a href="{{ url(app('aurl').'/orders?status=panding') }}" class="btn yellow">{{ trans('admin.panding') }}</a>
<a href="{{ url(app('aurl').'/orders?status=accept') }}" class="btn green">{{ trans('admin.accept') }}</a>
<a href="{{ url(app('aurl').'/orders?status=refused') }}" class="btn red">{{ trans('admin.refused') }}</a>
						...
						<div class="portlet-body">
							<div class="table-responsive">
								...
								<tr>
									...
									<td>
									<a href="{{ url(app('aurl').'/orders/'.$slide->id.'/edit') }}" title="{{ trans('admin.edit') }}" class="btn green"><i class="fa fa-edit"></i></a>
									<a href="#" class="btn red delrec" classform="deleteform{{ $slide->id }}" title="{{ trans('admin.delete') }}"><i class="fa fa-times"></i></a>
									{!! Form::open(['method'=>'delete','url'=>app('aurl').'/orders/'.$slide->id,'class'=>'deleteform'.$slide->id]) !!}
									{!! Form::close() !!}
									</td>
								</tr>
								@endforeach
