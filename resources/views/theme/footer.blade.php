        ...
        <div class="container">
          <div class="row text-white">
            ...
            <div class="col-lg-2 col-md-3 col-6 minister  mt-4 mb-3">
              <img class="etqan-footer-img" src="{{ asset('assets/images/gam3yah.png') }}" alt="">
{{--            @if(session()->has('success') )--}}
{{--            	<div class="alert alert-success">--}}
{{--            		{{ session()->get('success') }}--}}
{{--            	</div>--}}
{{--            @endif--}}
{{--              <h5 class="font-weigh-bold mb-2">ارسال</h5>--}}
...
{{--		--}}
{{--                <div class="row">--}}
{{--                  <div class="col-md-12 mb-2  med-1">--}}
{{--                    <input--}}
{{--                    name="name" required--}}
{{--                    placeholder="الإسم" type="text" class="form-control ">--}}
{{--                  </div>--}}
{{--                  <div class="col-md-12 mb-2  med-2">--}}
{{--                    <input --}}
{{--                    name="email" required--}}
{{--                    placeholder="البريد الإلكترونى" type="text" class="form-control ">--}}
{{--                  </div>--}}
{{--                  <div class="col-12">--}}
{{--                    <textarea --}}
{{--                    name="content" required--}}
{{--                    placeholder="الرسالة" class="form-control "  id="" cols="30" rows="5"></textarea>--}}
{{--                  </div>--}}
{{--                  <div class="text-left col-12 my-2">--}}
{{--                    <button class="contact-btn w-100 py-1">إرسال</button>--}}
{{--                  </div>--}}
{{--                </div>--}}
{{--    --}}
{{--              </form>--}}
            ...
            <div class="col-lg-2 col-md-3 col-6 mt-4 mb-3">
              ...
              <ul class="list-unstyled plus-info p-0 text-left">
                <li><small><a class="text-white" href="" > <span class="ph-n"><bdo
                        dir="rtl">{{@App\Setting::all()->first()->fax}}</bdo></span> <span class="footer-link"> <i
                        class="fas footer-yellow  fa-phone-alt"></i></span></a></small></li>
                <li><small><a class="text-white" href=""> <span class="ph-n"><bdo
                        dir="rtl">{{@App\Setting::all()->first()->mobile2}}</bdo></span> <span class="footer-link"> <i
                        class="fas footer-yellow  fa-mobile-alt"></i></span></a></small></li>
                <li><small><a class="text-white" href="" > {{@App\Setting::all()->first()->sitemail}} <span class="footer-link"> <i
                        class="fas footer-yellow  fa-envelope"></i></span></a></small></li>
                <li><small><a class="text-white" href=""> {{@App\Setting::all()->first()->siteurl}} <span class="footer-link"> <i
        ...
        <div class="last-footer container-fluid">
          ...
          <div>
            <a href="https://www.const-tech.com.sa/" target="_black"
              ><img class="c-logo" src="{{asset('assets/images/company-logo.svg')}}" alt="" />
            </a>
          </div>
        </div>
      </div>
    ...
    <script src="{{ asset('assets/js/crawler.js') }}"></script>
