        ...
        <div class="step1content">
          <h1>حالة الطلب</h1>
            ...
            @if($order->status == 'accept')
              ...
              <div class="alert alert-success" role="alert">تم قبول طلبك ويرجي تحميل الملفات الخاصة بالجهات الحكومية</div>
            @endif
            ...
            <div class="pull-left"><a href="{{url('step/3')}}" class="nextstep">التالي <i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a></div>
            @endif
