...
HijriDate.monthNames = ["محرم", "صفر", "ربيع الاول", "ربيع الاخر", "جمادى الاولى", "جمادى الاخر",
					   "رجب", "شعبان", "رمضان", "شوال", "ذو القعدة", "ذو الحجة"];

HijriDate.monthShortNames = ['Muh', 'Saf', 'RAw', 'RAk', 'JAw', 'JAk', 'Raj', 'Sha', 'Ram', 'Sya', 'DhQ', 'DhH'];

HijriDate.weekdayNames = ["الاحد", "الاثنين", "الثلاثاء", "الاربع", "الخميس", "الجمعة", "السبت"];

HijriDate.weekdayShortNames = ['احد', 'اثنين', 'ثلاثاء', 'اربع', 'خميس', 'جمعة', 'سبت'];
