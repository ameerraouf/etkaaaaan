...
<link href="<?php echo e(url('/')); ?>/assets/css/pages/error-rtl.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="<?php echo e(url('/')); ?>/assets/img/pages/earth-rtl.jpg" class="img-responsive" alt="">
</div>
<div class="container error-404">
	...
	<?php elseif(auth()->user()->level == 'store' || auth()->user()->level == 'user'): ?>
...
<!-- END CORE PLUGINS -->
<script src="<?php echo e(url('/')); ?>/assets/scripts/core/app.js"></script>
<script>
