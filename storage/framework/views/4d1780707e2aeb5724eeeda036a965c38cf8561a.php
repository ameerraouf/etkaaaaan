      ...
      <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" bgcolor="#ffffff">
        <tr>
          <td class="container-padding" bgcolor="#ffffff" style="background-color: #ffffff; padding-left: 30px; padding-right: 30px; font-size: 14px; line-height: 20px; font-family: Helvetica, sans-serif; color: #333;">
            ...
            مرحبا بك يا (<?php echo e($name); ?>) معنا ونشكرك على ثقتك فى <b><a href="<?php echo e(url('/')); ?>"><?php echo e(@$sitename); ?></a></b> 
            ...
            <?php echo e($email); ?>
             ...
             <br>
            <br>
            <strong>رابط تفعيل عضويتك هو:</strong>
             
            <br>
            <a href="<?php echo e(URL::to('active/'.$url)); ?>"><?php echo e(URL::to('active/'.$url)); ?></a>
            <br>
            <br>
            
            <br>
            <em style="font-style:italic; font-size: 12px; color: #aaa;"><?php echo e(@$sitename); ?> <a href="<?php echo e(url('/')); ?>"><?php echo e(url('/')); ?></a></em>
            <br><br>
