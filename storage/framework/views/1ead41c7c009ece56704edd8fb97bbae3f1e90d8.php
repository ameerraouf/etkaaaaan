...
<a href="<?php echo e(url(app('aurl').'/YearReaports/create')); ?>" class="btn green"><?php echo e(trans('admin.add')); ?></a>
...
<!-- BEGIN SAMPLE TABLE PORTLET-->
			 ...
			 <img src="<?php echo e(asset('assets/uplodedimage/'.$row->img)); ?>"
                      style="width:50px;height:50px;border-radius:50%" />
									...
									<td>
	<a href="<?php echo e(url(app('aurl').'/YearReaports/'.$row->id.'/edit')); ?>" title="" class="btn green"><i class="fa fa-edit"></i></a>
								    ...
								    <?php echo Form::open(['method'=>'delete','url'=>app('aurl').'/YearReaports/'.$row->id,'class'=>'deleteform'.$row->id]); ?>
