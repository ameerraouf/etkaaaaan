<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
    ...
    <li class="start " style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Market' )); ?>">
    ...
    <li class="start "  style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Episodes' )); ?>">
            <i class="fa fa-envelope-o" aria-hidden="true"></i>

            <span class="title">
						طلبات الحلقات
						[ <?php echo e(App\Episode::count()); ?> ]
						</span>
            <span>
						</span>
        </a>
    ...
    <li class="start "  style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Numbers' )); ?>">
    ...
    <li class="start " style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Pay' )); ?>">
            <i class="fa fa-money"></i>
            <span class="title">
						المدفوعات
						</span>
						
           <span class="label btn-danger" style="border-radius:10px;">
						    <?php echo e(App\Pay::where('read_it' , 'no')->get()->count()); ?>
    ...
    <li class="start " style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Ads' )); ?>">
    ...
    <li class="start " style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Said' )); ?>">
    ...
    <li class="start " style="border-top:1px solid #5c5c5c ">
        <a href="<?php echo e(url(app('aurl') .'/Rates' )); ?>">
