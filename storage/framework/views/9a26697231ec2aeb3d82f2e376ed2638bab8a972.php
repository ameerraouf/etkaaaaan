...
<form action="<?php echo e(url( app('aurl').'/pages/store' )); ?>" 
...
<div class="form-group">
<label><?php echo e(trans('admin.active')); ?> <input type="checkbox"  name="active" value="1" <?php if(old('active')): ?> checked <?php endif; ?> /> </label>	
</div>
