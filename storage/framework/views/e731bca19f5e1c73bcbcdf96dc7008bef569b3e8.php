<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
    ...
    <li class="<?php if(Request::segment(2) == 'ImageCategory'): ?> active open <?php endif; ?>">
        <a href="javascript:;">
            <i class="fa fa-list"></i>
            <span class="title">
                        <?php echo e(trans('admin.ImageCategory')); ?>
        ...
        <ul class="sub-menu">
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/ImageCategory">
                    <?php echo e(trans('admin.ImageCategory')); ?>

                </a>
            </li>
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/ImageCategory/create">
                    <?php echo e(trans('admin.add')); ?>
    ...
    <li class="<?php if(Request::segment(2) == 'MyImage'): ?> active open <?php endif; ?>">
        <a href="javascript:;">
            <i class="fa fa-list"></i>
            <span class="title">
                        <?php echo e(trans('admin.MyImage')); ?>
        ...
        <ul class="sub-menu">
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/MyImage">
                    <?php echo e(trans('admin.MyImage')); ?>

                </a>
            </li>
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/MyImage/create">
                    <?php echo e(trans('admin.add')); ?>
    ...
    <li class="<?php if(Request::segment(2) == 'VideoCategory'): ?> active open <?php endif; ?>">
        <a href="javascript:;">
            <i class="fa fa-list"></i>
            <span class="title">
                        <?php echo e(trans('admin.VideoCategory')); ?>
        ...
        <ul class="sub-menu">
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/VideoCategory">
                    <?php echo e(trans('admin.VideoCategory')); ?>

                </a>
            </li>
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/VideoCategory/create">
                    <?php echo e(trans('admin.add')); ?>
    ...
    <li class="<?php if(Request::segment(2) == 'MyVideo'): ?> active open <?php endif; ?>">
        <a href="javascript:;">
            <i class="fa fa-list"></i>
            <span class="title">
                        <?php echo e(trans('admin.MyVideo')); ?>
        ...
        <ul class="sub-menu">
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/MyVideo">
                    <?php echo e(trans('admin.MyVideo')); ?>

                </a>
            </li>
            <li>
                <a href="<?php echo e(url(app('aurl'))); ?>/MyVideo/create">
                    <?php echo e(trans('admin.add')); ?>
