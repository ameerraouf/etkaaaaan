...
<a href="<?php echo e(url(app('aurl').'/Albume/create')); ?>" class="btn green"><?php echo e(trans('admin.add')); ?></a>
...
<!-- BEGIN SAMPLE TABLE PORTLET-->
         ...
         <img src="<?php echo e(asset('assets/uplodedimage/'. $said->img)); ?>"
                                    ...
                                    <td>
    <a href="<?php echo e(url(app('aurl').'/Albume/'.$said->id.'/edit')); ?>" title="" class="btn green"><i class="fa fa-edit"></i></a>
                                    ...
                                    <?php echo Form::open(['method'=>'delete','url'=>app('aurl').'/Albume/'.$said->id,'class'=>'deleteform'.$said->id]); ?>
